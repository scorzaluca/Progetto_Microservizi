...
\begin{enumerate}
  ...
  \item \textbf{Garantire osservabilità end-to-end} dell'intero sistema, fornendo visibilità su log, tracce distribuite e metriche di tutti i componenti per facilitare il debugging e il monitoraggio operativo.
\end{enumerate}
...
\begin{itemize}
  \item \textbf{RNF-01 -- Osservabilità:} Raccolta centralizzata di log (Loki), tracce distribuite (Tempo) e metriche (Prometheus) tramite OpenTelemetry Collector, con datasource Grafana preconfigurati.
