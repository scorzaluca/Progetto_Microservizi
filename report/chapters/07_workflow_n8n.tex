...
\textit{Inserire qui uno screenshot del Routing Workflow dall'interfaccia di n8n, mostrando i nodi Webhook $\to$ Redis Get $\to$ If $\to$ branching verso Discovery/Refinement.}
\end{warningbox}
...
% ── NOTA IMMAGINE ────────────────────────────────────────────────────────────
\begin{warningbox}{Suggerimento: Immagine}
\textit{Inserire qui uno screenshot del Discovery Workflow completo dall'interfaccia di n8n. Questo è il workflow più complesso e il suo diagramma visuale è essenziale per la comprensione.}
\end{warningbox}
...
% ── NOTA IMMAGINE ────────────────────────────────────────────────────────────
\begin{warningbox}{Suggerimento: Immagine}
\textit{Inserire qui uno screenshot del Refinement Workflow dall'interfaccia di n8n, evidenziando il branching tra modalità Explain e Modify.}
\end{warningbox}
