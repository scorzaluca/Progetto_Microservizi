...
\textit{Inserire qui uno screenshot dell'interfaccia chat in funzione, mostrando: (1) l'header con il pulsante ``Nuova Chat'', (2) l'area messaggi con bolle utente e agente, (3) l'area di input a destra. Idealmente catturare un momento durante l'intervista con almeno 2-3 scambi di messaggi.}
\end{warningbox}
